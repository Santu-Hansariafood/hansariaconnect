...
import { useState, ChangeEvent, useEffect, useMemo, Suspense } from "react";
...
const CreateGroup: React.FC<CreateGroupProps> = ({ user, theme }) => {
  ...
  const [groupPhoto, setGroupPhoto] = useState("/logo/logo.png");
      ...
      try {
        ...
        if (res.ok && Array.isArray(data?.contacts)) {
          const mapped: Contact[] = data.contacts.map((contact: any) => ({
            ...
            avatar: contact.avatar || "/logo/logo.png",
